    ...
    ui.group(|ui| {
        ...
        ui.horizontal(|ui| {
            ...
            egui::ComboBox::from_id_source("settings_log_level_cb")
                ...
                .show_ui(ui, |ui| {
                    ui.selectable_value(&mut app.config.general.log_level, "trace".to_string(), "trace");
                    ui.selectable_value(&mut app.config.general.log_level, "debug".to_string(), "debug");
                    ui.selectable_value(&mut app.config.general.log_level, "info".to_string(), "info");
    ...
    ui.group(|ui| {
        ...
        ui.horizontal(|ui| {
            ...
            egui::ComboBox::from_id_source("settings_default_quality_cb")
                .selected_text(match app.config.training.default_quality.as_str() {
                    "fast" => "Fast (1 Layer MLP)",
                    "max-savings" => "Max Savings (INT8 Quantized)",
                    _ => "Balanced (3 Layers MLP)",
                })
                .show_ui(ui, |ui| {
                    ui.selectable_value(
                        &mut app.config.training.default_quality,
                        "fast".to_string(),
                        "Fast (1 Layer MLP)",
                    );
                    ui.selectable_value(
        ...
        ui.horizontal(|ui| {
            ...
            egui::ComboBox::from_id_source("settings_target_precision_cb")
                ...
                .show_ui(ui, |ui| {
                    ui.selectable_value(
                        &mut app.config.training.target_precision,
                        "fp16".to_string(),
                        "FP16 Standard",
                    );
                    ui.selectable_value(
